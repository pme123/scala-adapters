...
**1.** For a **new site**, install the `scala-adapters-jekyll` theme gem or fork the Scala Adapters repo on GitHub following the steps outlined in the [*Business*]({{ "/docs/business-view/" | absolute_url }}).
...
**2.** For an **existing site** follow the steps outlined in the [*Business*]({{ "/docs/business-view/" | absolute_url }}). Then work through the guidelines below for migration and setup.
